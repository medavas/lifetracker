...
import { orderableEntries, pinnedEntries } from '../../lib/sidebarOrder'
...
describe('AreaIcon', () => {
  ...
  it('has a registry entry for every pinned top-section icon', () => {
    for (const e of pinnedEntries()) expect(ICONS[e.icon], e.icon).toBeTruthy()
  })
